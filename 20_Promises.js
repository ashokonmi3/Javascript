...
// console.log(
//   "This runs immediately after the promise, before the cake is done.",
// );
...
//   setTimeout(resolve, 500, "Video one finished"),
// );
// const videoTwo = new Promise((resolve, reject) =>
//   setTimeout(resolve, 2000, "Video two finished"),
// );
...
const promiseTwo = new Promise((resolve, reject) =>
  setTimeout(reject, 1500, "Task 2 failed"),
);
