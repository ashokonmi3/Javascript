...
// console.log(5.0); // Output: 5, The decimal is just a format, it's still 5
...
// console.log(parseFloat(10.0)); // Output: 10
...
// console.log(parseFloat("33 he is")); // Output: NaN, starts with a non-number
